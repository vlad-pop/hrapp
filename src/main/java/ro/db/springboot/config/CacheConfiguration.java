...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(ro.db.springboot.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(ro.db.springboot.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
            cm.createCache(ro.db.springboot.domain.User.class.getName(), jcacheConfiguration);
            cm.createCache(ro.db.springboot.domain.Authority.class.getName(), jcacheConfiguration);
